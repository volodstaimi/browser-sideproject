...
function buildAppMenu(windowsMod) {
  ...
  const template = [
    ...
    },
    {
      label: 'Tools',
      submenu: [
        { label: 'Command Palette', accelerator: 'CmdOrCtrl+K', click: dispatch('command-palette') },
        { label: 'Command Palette (alt)', accelerator: 'CmdOrCtrl+Shift+P', visible: false, click: dispatch('command-palette') },
        { type: 'separator' },
        ...
        { label: 'Reading List', click: dispatch('open-reading-list') },
        { type: 'separator' },
        { label: 'Reader Mode', click: dispatch('reader') },
        { label: 'Picture in Picture', click: dispatch('pip') },
        { label: 'Translate Page', click: dispatch('translate') },
        { label: 'Capture Screenshot', accelerator: 'CmdOrCtrl+Shift+S', click: dispatch('screenshot') },
        { type: 'separator' },
        { label: 'Toggle Vertical Tabs', click: dispatch('toggle-vertical-tabs') },
        { label: 'Toggle Dark Mode on Sites', click: dispatch('toggle-force-dark') },
